...
resultaten["Jumbo"] = { naam: p.title, prijs: Math.round(p.prices.price.amount), normaal: Math.round((p.prices.promotionalPrice && p.prices.promotionalPrice.amount) || p.prices.price.amount), aanbieding: p.prices.promotionalPrice ? "Weekd
